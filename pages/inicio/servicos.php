...
<section class="section-py landing-services" id="landingServices">
    <div class="container position-relative">
        ...
        <div class="text-center mb-5 pb-3">
            <div class="services-badge mx-auto mb-4">
                <span class="badge-icon">◆</span>
                <span class="badge-text">NOSSOS SERVIÇOS</span>
            </div>
            <h2 class="services-title mb-4">
                Soluções Completas<br>
                <span class="text-gradient">Para o Seu Negócio</span>
            </h2>
            <p class="services-subtitle mx-auto">
                Da infraestrutura à formação, oferecemos tudo o que precisa para transformar digitalmente a sua empresa
            </p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="service-card">
                    ...
                    <a href="servicos/desenvolvimento-software" class="service-btn">
