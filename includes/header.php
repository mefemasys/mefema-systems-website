...
<script>
  ...
  <style>
    ...
    @media (max-width: 991px) {
      .landing-nav-menu {
        background: linear-gradient(135deg, var(--mefema-brown-dark) 0%, var(--mefema-brown) 100%);
