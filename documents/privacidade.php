...
<section class="section-py bg-body-secondary">
  <div class="container">
    <div class="text-center">
      <span class="badge bg-label-primary mb-3">Documentos Legais</span>
        ...
        <div class="card sticky-top" style="top: 100px;">
          <div class="card-body">
            ...
            <nav class="nav flex-column">
              <a class="nav-link text-muted py-2" href="#introducao">
                <i class="ri-arrow-right-s-line me-1"></i>Introdução
              </a>
              <a class="nav-link text-muted py-2" href="#controlador">
                <i class="ri-arrow-right-s-line me-1"></i>Controlador de Dados
              </a>
              <a class="nav-link text-muted py-2" href="#dados-recolhidos">
                <i class="ri-arrow-right-s-line me-1"></i>Dados Recolhidos
              </a>
              <a class="nav-link text-muted py-2" href="#seguranca">
                <i class="ri-arrow-right-s-line me-1"></i>Segurança
              </a>
              <a class="nav-link text-muted py-2" href="#partilha">
                <i class="ri-arrow-right-s-line me-1"></i>Partilha de Dados
              </a>
              <a class="nav-link text-muted py-2" href="#direitos">
                <i class="ri-arrow-right-s-line me-1"></i>Direitos do Titular
              </a>
              <a class="nav-link text-muted py-2" href="#armazenamento">
                <i class="ri-arrow-right-s-line me-1"></i>Armazenamento
              </a>
              <a class="nav-link text-muted py-2" href="#responsavel">
        ...
        <div class="card">
          <div class="card-body p-4 p-lg-5">
            ...
            <div id="introducao" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-information-line text-primary me-2"></i>Introdução e Âmbito
              </h2>
              <p class="mb-3">
              ...
              <div class="row g-3 mt-3">
                <div class="col-md-6">
                  <div class="card border-start border-primary border-3">
                    <div class="card-body">
                      <h6><i class="ri-focus-3-line text-primary me-2"></i>Minimização de Dados</h6>
                ...
                <div class="col-md-6">
                  <div class="card border-start border-success border-3">
                    <div class="card-body">
                      <h6><i class="ri-eye-line text-success me-2"></i>Transparência</h6>
                ...
                <div class="col-md-6">
                  <div class="card border-start border-info border-3">
                    <div class="card-body">
                      <h6><i class="ri-lock-2-line text-info me-2"></i>Segurança por Desenho</h6>
                ...
                <div class="col-md-6">
                  <div class="card border-start border-warning border-3">
                    <div class="card-body">
                      <h6><i class="ri-settings-3-line text-warning me-2"></i>Controlo do Utilizador</h6>
            ...
            <div id="controlador" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-building-line text-primary me-2"></i>Controlador de Dados
              </h2>
            ...
            <div id="dados-recolhidos" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-database-2-line text-primary me-2"></i>Dados Pessoais Recolhidos
              </h2>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><span class="badge bg-label-primary">Execução de Contrato</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span class="badge bg-label-success">Interesse Legítimo</span></td>
                    </tr>
                    <tr>
            ...
            <div id="seguranca" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-shield-keyhole-line text-primary me-2"></i>Segurança dos Dados
              </h2>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                          <i class="ri-lock-password-line text-primary fs-1"></i>
                        </div>
                ...
                <div class="col-md-6">
                  <div class="card h-100 border-success">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                          <i class="ri-customer-service-2-line text-success fs-1"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div id="partilha" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-share-line text-primary me-2"></i>Partilha de Dados
              </h2>
              ...
              <div class="accordion" id="accordionPartilha">
            ...
            <div id="direitos" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-user-settings-line text-primary me-2"></i>Direitos do Titular dos Dados
              </h2>
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-eye-line text-primary me-2"></i>Direito de Acesso</h6>
                      <p class="small mb-0">Confirmar e aceder aos dados que possuímos</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-edit-line text-success me-2"></i>Direito de Rectificação</h6>
                      <p class="small mb-0">Corrigir dados incompletos ou inexactos</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-delete-bin-line text-danger me-2"></i>Direito ao Apagamento</h6>
                      <p class="small mb-0">Solicitar eliminação dos seus dados pessoais</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-pause-circle-line text-warning me-2"></i>Limitação do Tratamento</h6>
                      <p class="small mb-0">Suspender o tratamento em circunstâncias específicas</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-folder-transfer-line text-info me-2"></i>Direito à Portabilidade</h6>
                      <p class="small mb-0">Receber dados em formato estruturado e legível</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><i class="ri-close-circle-line text-secondary me-2"></i>Direito de Oposição</h6>
                      <p class="small mb-0">Opor-se ao tratamento baseado em interesse legítimo</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="armazenamento" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-save-line text-primary me-2"></i>Armazenamento e Retenção
              </h2>
            ...
            <div id="responsavel" class="mb-5">
              <h2 class="mb-4">
                <i class="ri-contacts-line text-primary me-2"></i>Responsável pela Protecção de Dados
              </h2>
